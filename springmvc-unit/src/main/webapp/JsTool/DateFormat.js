 ...
 * DateFormat.getDateStart(new Date()) , 'yyyyMMdd')
 * DateFormat.getDateEndStr(new Date(), 'yyyy/MM/dd')
 * DateFormat.getWeek(new Date(),DateFormat.WEEKTYPE.US_DAYNAME)
 * DateFormat.addDay(new Date(), '3')
 * DateFormat.format(new Date())
 * DateFormat.formatToDate('2017/04/14 14:31:07')
 * DateFormat.isValidDate('2017-04-14 14:31:07')
 * DateFormat.format(new Date());
 * DateFormat.addDayStr('2017-04-18 12:12:12' , 3)
 */
(function () {
	//定义一些默认参数
	var _options = {
