...
*/       
    ...
    public static void main(String[] args){    
      NumberToos util=new NumberToos();    
      System.out.println(util.sqrt(100));  
      double number = 3.1345;
      number = keepPrecision(number,5); 
	 ...
	 * @return
	 */
	public static String roundPrecision(double number, int precision) {
		if(precision < 0) {
